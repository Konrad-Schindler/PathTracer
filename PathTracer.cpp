...
private:
    ...
    static VKAPI_ATTR VkBool32 VKAPI_CALL debugCallback(
        ...
        std::cerr << "[" << messageSeverity << "]" <<" validation layer: " << pCallbackData->pMessage << std::endl;
    ...
    bool isDeviceSuitable(VkPhysicalDevice device) {
        ...
        bool swapChainAdequadee = !swapChainSupport.formats.empty() && !swapChainSupport.presentModes.empty();

        return swapChainAdequadee;
    }
    ...
    VkSurfaceFormatKHR chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats) {
        ...
        throw std::runtime_error("No srgb format found. Dont want to bother.");
    }
